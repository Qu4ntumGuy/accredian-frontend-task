  ...
  const submitHandler = async (e) => {
    ...
    try {
      ...
      if (res.status === 201) {
        ...
        setSuccess("Referral Form Submitted. Thank you!");
      }
    } catch (error) {
  ...
  return (
    <div>
      <form className="w-full">
        ...
        >
          {error && (
            <div className="text-lg border-red-500 border p-2 w-96 text-red-500 rounded-lg">
              {error}
            </div>
          )}
          {success && (
            <div className="text-lg border-green-500 border p-2 w-96 text-green-500 rounded-lg">
              {success}
            </div>
          )}
          <button

      ...
      <section className=" bg-[#EEF5FF] w-full">
        ...
        <div className=" max-w-[85rem] mx-auto">
          ...
          <div className="relative py-5 flex text-base font-medium">
            <div className=" absolute flex flex-col items-center justify-center top-44 left-52 w-48">
              <div className="w-full flex justify-center">
                <img src={addFriend} alt="add friend" className="pb-5 h-16" />
              </div>
              <p className="w-full  text-center">
                Submit referrals easily via our website’s referral section.
              </p>
            </div>
            <div className=" absolute top-0 right-72 z-10 w-48">
              <div>
                <img src={reward} alt="add friend" className="" />
              </div>
              <p>Earn rewards once your referral joins an Accredian program.</p>
            </div>
            <div className=" absolute w-48">
              <img src={bonus} alt="add friend" className="" />
              <p>

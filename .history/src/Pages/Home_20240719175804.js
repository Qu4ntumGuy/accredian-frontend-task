      ...
      <section className="h-screen w-ful">
        <div className="max-w-[77rem] my-5 mx-auto">
          ...
          <div className="my-10 text-lg">
            ...
            <div className="flex justify-between h-[576px]">
              <div className=" shadow-2xl w-72 text-base font-semibold rounded-xl">
                <div className="h-16 px-4 bg-[#1A73E8] w-full rounded-t-md flex justify-start items-center text-white ">
                  ALL PROGRAMS{" "}

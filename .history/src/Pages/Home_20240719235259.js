        ...
        <div className="max-w-7xl mx-auto my-5">
          ...
          <div className="flex w-full my-20 justify-between">
            <div className="flex flex-col w-64 font-semibold">
              ...
              <button className="w-full hover:bg-stone-300 border-2 text-stone-400 border-stone-400 my-5 rounded-lg h-16">
                How To Use?
              </button>
              <button className="w-full hover:bg-stone-300 border-2 text-stone-400 border-stone-400 rounded-lg h-16">
                terms & Conditions
              </button>
            </div>
            <div className=" w-[70%]">

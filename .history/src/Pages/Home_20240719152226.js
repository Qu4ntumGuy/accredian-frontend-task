      ...
      <section className="h-[100vh] bg-stone-100">
        ...
        <div>
          <div className="flex w-full justify-center items-center">
            <div className="flex bg-[#1A73E8] bg-opacity-15 p-3 justify-between items-center w-1/2 h-16">
              <div className="text-[#1A73E8] w-full">Refer</div>
              <div className="w-full">Refer</div>
              <div className="w-full">Refer</div>
              <div className="w-full">Refer</div>
            </div>
          </div>

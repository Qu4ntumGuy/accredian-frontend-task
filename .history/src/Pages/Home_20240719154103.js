...
function Home() {
  ...
  return (
    <div className="">
      <div className="w-full top-0 sticky bg-[#1A73E8] bg-opacity-15 h-14 flex justify-center items-center">
      ...
      <section className="max-w-[85rem] mx-auto h-[100vh]">
        ...
        <div>
          ...
          <div className="w-full flex mt-5 h-[692px] shadow-2xl rounded-xl border-y-2">
            <div></div>
            <div>
              <img src={pic} alt="pic" />
            </div>

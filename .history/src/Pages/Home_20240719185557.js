          ...
          <div className="my-10 text-lg">
            ...
            <div className="flex justify-between h-auto">
              ...
              <div className="shadow-2xl ml-10 flex w-[920px] text-lg rounded-xl text-[#3C4852]">
                <div className="w-[58%] border-r-2 border-gray-300">
                ...
                <div className="w-[21%] border-r-2 border-gray-300">
                  <div className="text-[#1350A0] px-5 h-14 flex items-center rounded-ss-xl bg-[#1A73E8] bg-opacity-35 font-bold"></div>
                </div>

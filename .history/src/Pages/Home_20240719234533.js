        ...
        <div className="max-w-7xl mx-auto my-5">
          ...
          <div className="flex w-full my-20 justify-between">
            <div className="flex flex-col w-64">
              ...
              <button className="w-full hover:bg-stone-300 border border-stone-500 my-5 rounded-lg h-16">
                How To Use?
              </button>
              <button className="w-full hover:bg-stone-300 border border-stone-500 rounded-lg h-16">
                terms & Conditions
              </button>
            </div>
            <div className="ml-10">
              <div className="flex justify-center items-center text-[#1A73E8] text-base h-16 font-semibold">
                Do I need to have prior Product Management and Project
                Management experience to enroll in the program?
                <span>
                  <KeyboardArrowUpRoundedIcon className="text-black" />
                </span>
              </div>
              <div></div>
              <div></div>

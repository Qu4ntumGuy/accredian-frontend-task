        ...
        <div className="max-w-[77rem] my-5 mx-auto">
          ...
          <div className="my-10 text-lg">
            ...
            <div className="flex justify-between h-auto">
              ...
              <div className="shadow-2xl flex w-[920px] text-lg rounded-xl text-[#3C4852]">
                <div className="w-3/5 border-r-2">
                  <div className="text-[#1350A0] px-5 font-semibold h-14 flex items-center rounded-ss-xl bg-[#1A73E8] bg-opacity-35 font-semibold">
                    Programs
                  </div>

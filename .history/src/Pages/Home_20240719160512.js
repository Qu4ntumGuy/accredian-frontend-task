    ...
    <div className="">
      ...
      <section className="max-w-[85rem] mx-auto h-[100vh]">
        ...
        <div>
          ...
          <div className="w-full justify-start flex mt-5 h-[692px] shadow-2xl rounded-2xl border-y-2">
            <div className="h-full w-[502px] flex flex-col justify-end py-16 pl-12 pt-32">
              ...
              <div className="text-4xl my-16">
                ...
                <div>
                  up-to
                  <span className="text-[#1A73E8] ml-2 font-bold">
                    Rs. 15,000
                  </span>
                </div>
              </div>

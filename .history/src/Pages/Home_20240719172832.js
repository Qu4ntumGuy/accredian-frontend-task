  ...
  return (
    <div className="text-[#1A202C]">
      ...
      <section className="h-screen w-full">
        <div className="max-x-[85rem] my-5 mx-auto">
          <div className="text-[27.66px] py-20 flex justify-center items-center align-middle font-semibold">
            What Are The{" "}
            <span className="text-[#1A73E8]">Referral Benefits?</span>
          </div>
          <div>
            <div>
              <img src={toggle} alt="pic" className=" absolute top-0 left-0" />
            </div>
            <div>
              <div></div>
              <div></div>

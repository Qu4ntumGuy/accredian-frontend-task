...
function Home() {
  ...
  return (
    <div className="">
      <div className="w-full top-0 sticky bg-blue-100 h-16 flex justify-center items-center">
      ...
      <section className="max-w-[85rem] mx-auto h-[100vh]">
        ...
        <div>
          <div className="flex w-full justify-center items-center">
            <div className="flex text-xl bg-[#1A73E8] bg-opacity-15 p-3 rounded-full justify-between items-center w-1/2 h-14">

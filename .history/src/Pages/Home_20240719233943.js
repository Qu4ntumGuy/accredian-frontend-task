        ...
        <div className="max-w-7xl mx-auto my-5">
          ...
          <div className="flex w-full my-20">
            <div className="flex flex-col w-64">
              ...
              <button className="w-full hover:bg-stone-300 shadow-xl border border-stone-500 my-5 rounded-lg h-16">
                How To Use?
              </button>
              <button className="w-full hover:bg-stone-300 shadow-xl border border-stone-500 rounded-lg h-16">
                terms & Conditions
              </button>
            </div>
            <div></div>
